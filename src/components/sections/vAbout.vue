      ...
      <div class="about">
        <div class="about__content">
          <div class="about__content-item">
            <img class="about__img" src="../../assets/about.webp" alt="Background">
            <div class="about__content-abs">
              <img class="about__svg" src="../../assets/text.svg" alt="Text">
              <img class="about__emoji" src="../../assets/work.png" alt="Work">
            </div>
          </div>
          <div class="about__content-item">
