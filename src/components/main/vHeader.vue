    ...
    <div class="container">
      <div class="header">
        ...
        <div class="header__actions">
          <div class="header__switch" @click="store.changeTheme()">
            <span v-if="store.checkTheme === 'light'">Light</span>
            <span v-else>Dark</span>
            <div v-if="store.checkTheme === 'light'">
            ...
            <div v-else>
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                   width="50" height="50" viewBox="0 0 256 256" xml:space="preserve">
                <defs></defs>
          ...
          <nav class="nav" :class="{_active: mobileMenu}">
            <ul class="nav__box">
              <li class="nav__box-item">
                <a
                  href="#"
              ...
              <li class="nav__box-close" @click="mobileMenu = !mobileMenu">
                <span>
                  <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="none">
                      <path d="M18 6L6 18" stroke="#2d2e32" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                      <path d="M6 6L18 18" stroke="#2d2e32" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                  </svg>
                </span>
              </li>
          ...
          <div class="header__btn" @click="mobileMenu = !mobileMenu">
            <span>
              <svg xmlns="http://www.w3.org/2000/svg" width="28px" height="28px" viewBox="0 0 24 24" fill="2d2e32">
